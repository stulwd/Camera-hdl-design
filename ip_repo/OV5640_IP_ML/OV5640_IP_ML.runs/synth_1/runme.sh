...
HD_PWD='D:/MIZ702/CH29/ip_repo/OV5640_IP_ML/OV5640_IP_ML.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV5640_IP_ML.vds -m64 -mode batch -messageDb vivado.pb -notrace -source OV5640_IP_ML.tcl
