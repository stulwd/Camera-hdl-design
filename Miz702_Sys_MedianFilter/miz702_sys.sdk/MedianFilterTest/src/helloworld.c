...
extern void MedianFilter(const unsigned char *pImg1,unsigned char *pImg,int nWidth,int nHeight);
extern void EdgeDetectionTemplate(const unsigned char *pSrcImg,unsigned char *pDstImg,
...
int main()
{
	...
	while(1)
	{
		show_img(0,0,VIDEO_BASEADDR0,&gImage_grayLena512[0],512,512);
	    sleep(3);
