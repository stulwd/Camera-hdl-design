...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set VGA_D [ create_bd_port -dir O -from 23 -to 0 VGA_D ]
  ...
  set cmos_sclk_o [ create_bd_port -dir O cmos_sclk_o ]
  set cmos_sdat_io [ create_bd_port -dir IO cmos_sdat_io ]
  set cmos_vsync_i [ create_bd_port -dir I cmos_vsync_i ]
  set cmos_xclk_o [ create_bd_port -dir O cmos_xclk_o ]

  # Create instance: CLK_VIDEO_OUT_GEN, and set properties
  set CLK_VIDEO_OUT_GEN [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 CLK_VIDEO_OUT_GEN ]
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {140.839} \
   CONFIG.CLKOUT1_PHASE_ERROR {101.231} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {74.5} \
   CONFIG.CLKOUT2_JITTER {177.138} \
   CONFIG.CLKOUT2_PHASE_ERROR {101.231} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {25} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {202.856} \
   CONFIG.CLKOUT3_PHASE_ERROR {101.231} \
  ...
  # Create instance: OV5640_IP_ML_0, and set properties
  set OV5640_IP_ML_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:OV5640_IP_ML:1.0 OV5640_IP_ML_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {NAND Flash#GPIO#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 0#UART 0#UART 1#UART 1#I2C 0#I2C 0#Enet 0#Enet 0} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M02_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M02_AXI] [get_bd_intf_pins video_lock_monitor/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins CLK_VIDEO_OUT_GEN/s_axi_lite] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net CLK_VIDEO_OUT_GEN_clk_out1 [get_bd_pins CLK_VIDEO_OUT_GEN/clk_out1] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net CLK_VIDEO_OUT_GEN_clk_out2 [get_bd_pins CLK_VIDEO_OUT_GEN/clk_out2] [get_bd_pins OV5640_IP_ML_0/CLK_i]
  connect_bd_net -net CLK_VIDEO_OUT_GEN_locked [get_bd_pins CLK_VIDEO_OUT_GEN/locked] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/clken] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins v_vid_in_axi4s_0/aclken] [get_bd_pins v_vid_in_axi4s_0/aresetn] [get_bd_pins v_vid_in_axi4s_0/axis_enable] [get_bd_pins v_vid_in_axi4s_0/vid_io_in_ce]
  connect_bd_net -net Net [get_bd_ports cmos_sdat_io] [get_bd_pins OV5640_IP_ML_0/cmos_sdat_io]
  connect_bd_net -net OV5640_IP_ML_0_cmos_sclk_o [get_bd_ports cmos_sclk_o] [get_bd_pins OV5640_IP_ML_0/cmos_sclk_o]
  connect_bd_net -net OV5640_IP_ML_0_cmos_xclk_o [get_bd_ports cmos_xclk_o] [get_bd_pins OV5640_IP_ML_0/cmos_xclk_o]
  connect_bd_net -net OV7725_IP_ML_0_clk_date_o [get_bd_pins OV5640_IP_ML_0/clk_date_o] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net OV7725_IP_ML_0_de_o [get_bd_pins OV5640_IP_ML_0/de_o] [get_bd_pins v_vid_in_axi4s_0/vid_active_video]
  connect_bd_net -net OV7725_IP_ML_0_hs_o [get_bd_pins OV5640_IP_ML_0/hs_o] [get_bd_pins v_vid_in_axi4s_0/vid_hsync]
  connect_bd_net -net OV7725_IP_ML_0_rgb_o [get_bd_pins OV5640_IP_ML_0/rgb_o] [get_bd_pins v_vid_in_axi4s_0/vid_data]
  connect_bd_net -net OV7725_IP_ML_0_vs_o [get_bd_pins OV5640_IP_ML_0/vs_o] [get_bd_pins v_vid_in_axi4s_0/vid_vsync]
  ...
  connect_bd_net -net cmos_data_i_1 [get_bd_ports cmos_data_i] [get_bd_pins OV5640_IP_ML_0/cmos_data_i]
  connect_bd_net -net cmos_href_i_1 [get_bd_ports cmos_href_i] [get_bd_pins OV5640_IP_ML_0/cmos_href_i]
  connect_bd_net -net cmos_pclk_i_1 [get_bd_ports cmos_pclk_i] [get_bd_pins OV5640_IP_ML_0/cmos_pclk_i]
  connect_bd_net -net cmos_vsync_i_1 [get_bd_ports cmos_vsync_i] [get_bd_pins OV5640_IP_ML_0/cmos_vsync_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins CLK_VIDEO_OUT_GEN/clk_in1] [get_bd_pins CLK_VIDEO_OUT_GEN/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/M04_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins video_lock_monitor/s_axi_aclk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins CLK_VIDEO_OUT_GEN/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M04_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins video_lock_monitor/s_axi_aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_ports VGA_D] [get_bd_pins v_axi4s_vid_out_0/vid_data]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs CLK_VIDEO_OUT_GEN/s_axi_lite/Reg] SEG_CLK_VIDEO_OUT_GEN_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_lock_monitor/S_AXI/Reg] SEG_axi_gpio_0_Reg
